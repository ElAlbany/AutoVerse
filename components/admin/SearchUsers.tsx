    ...
    <form onSubmit={handleSubmit} className="flex gap-2">
      <div className="relative">
        ...
        <input
          ...
          className="pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-primary-blue/20 focus:border-primary-blue w-72"
        />
      </div>
      <button
        type="submit"
