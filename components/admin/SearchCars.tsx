    ...
    >
      <div className="relative flex-1 sm:flex-none">
        ...
        <input
          ...
          className="pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 dark:border-dark-border text-sm focus:outline-none focus:ring-2 focus:ring-primary-blue/20 focus:border-primary-blue w-full sm:w-64 bg-white dark:bg-dark-card dark:text-dark-text transition-colors duration-500"
        />
      </div>
