              ...
              {serializedOrders.map((order) => (
                <div key={order.id} className="p-4 space-y-3">
                  <div className="flex items-start justify-between gap-2">
                    <code className="font-mono text-[11px] bg-gray-100 dark:bg-dark-surface px-2 py-1 rounded-lg text-gray-700 dark:text-dark-text transition-colors duration-500">
                      {order.id.slice(0, 8)}...
                    </code>
                  ...
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <p className="font-bold text-gray-900 dark:text-dark-text flex-shrink-0">
                      ${order.totalPrice}
                    </p>
                  </div>

                  <p className="text-sm capitalize text-gray-700 dark:text-dark-text">
